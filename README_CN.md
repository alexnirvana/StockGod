...
<p>
  <img alt="版本 0.5.0" src="https://img.shields.io/badge/version-0.5.0-6366f1?style=flat-square">
...
- 课程正文和常见教练回答提供内置中英文合成语音。
- 支持播放、暂停、重播、进度拖动、段落跳转和 0.75× 至 2× 语速，点击后才开始播放。
- 听课位置与语速按账号、课程和语言分别保存，在「学习档案 → 我的听课记录」中继续收听。
- 关闭讲解即停止播放；听完音频不会发放经验，也不会代替独立练习。
